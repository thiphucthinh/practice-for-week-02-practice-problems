...
const miahsCats = obj => {
    ...
    for (let key in obj) {
        ...
        let lowercaseValue = obj[key].toLowerCase();

        if (lowercaseKey.includes("cute") || lowercaseKey.includes("adorable") ||
            lowercaseValue.includes("cute") || lowercaseValue.includes("adorable")) {
            count++;
        }
    }
    return count;
